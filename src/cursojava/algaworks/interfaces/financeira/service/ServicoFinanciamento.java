...
import cursojava.algaworks.interfaces.financeira.model.ClienteFinanciavel;
...
public class ServicoFinanciamento {
    ...
    public void solicitarFinanciamento(ClienteFinanciavel cliente, double valorSolicitado) {
        ...
        System.out.printf("DEBUG: Financiamento aprovado no valor de %.2f com juros de %.2f%%. Limite máximo de %.2f%n",
