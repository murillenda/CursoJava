package cursojava.algaworks.logs.slf4jcomlogback;

import cursojava.algaworks.logs.slf4jcomlogback.exception.SaldoInsuficienteException;
import cursojava.algaworks.logs.slf4jcomlogback.model.ContaCorrente;
import cursojava.algaworks.logs.slf4jcomlogback.model.Titular;
...
public class Principal2 {
    ...
    private static final Logger logger = LoggerFactory.getLogger(Principal2.class);
